...
Given a small positive integer n, write a function that draws a diamond,
either filled or in outline as specified by the user. For instance, here are
filled and outline diamonds for n = 5:
 ...
 * * * *        *     *
  * * *          *   *
   * *            * *
    *              *
Note that there is a single space between asterisks in the filled version
of the diamond.
