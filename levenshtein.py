#-*- coding: utf-8 -*-
"""
In a previous exercise http://programmingpraxis.com/2009/06/09/longest-common-subsequence/ we computed the edit distance between two strings where the allowable operations were insert or delete characters; we made the calculation by determining the longest common subsequence. A different definition of edit distance allows substitutions as well as insertions and deletions, and is called the Levenshtein distance, since it was studied by Vladimir Levenshtein in 1965. For example, the edit distance between “hill” and “hilt” is 2 (delete the “l” and insert the “t”) but the Levenshtein distance is 1 (replace “l” by “t”).
...
Your task is to write two functions to compute the Levenshtein distance between two strings.

puzzle taken from: http://programmingpraxis.com/2014/09/12/levenshtein-distance/
"""
